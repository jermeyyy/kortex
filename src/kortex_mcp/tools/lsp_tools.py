...
from ..utils.async_utils import async_lru_cache
from .base import ToolError, ToolValidationError, with_timeout
...
class LSPTools:
    ...
    def __init__(self, lsp_manager: LSPManager, kmp_analyzer: KMPAnalyzer | None = None):
